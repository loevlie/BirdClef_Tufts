...
def main():
    ...
    for start in tqdm(range(0, n_files, batch_files), desc="Perch batches"):
        ...
        emb = outputs[0].astype(np.float32)  # embedding is first output
